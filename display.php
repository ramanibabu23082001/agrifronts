...
<body>
  ...
  <li><a href="display.php" class="active">Your Orders</a></li>
  ...
  <li class="dropdown">
	...
	<form name="name" action="display2.php" method="POST">
<h1>Crop Products</h1>
<table id="racetimes">
...
$a=$_SESSION['u'];
  ...
  $sql="SELECT * FROM products WHERE farmer='$a' and message='order placed'";
