...
<div class="hyh">
	<center><h1>POTATO</h1></center>
<div class="rtr">
	<img class="yty" src="potato.jpg">
</div>
<div class="ptr">
	<pre class="attr">
	...
	<form action="potato1.php" method="POST">
		<b>ENTER THE LAND AREA:</b><input type="text" name="potato"value="">  <input class="hhh" type="submit" name="submit" value="CLICK TO GET DETAILS">
	</form>
	</pre>
