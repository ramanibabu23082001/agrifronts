...
$sql="SELECT value FROM myupdates WHERE cropname='avarai'";
 			...
 			<ul id="mine">
				<tr>
					...
					<td><a href="avarai.php" ><center><b>Avarai</b>(1kg)</center></a></td>
						<td><center><input type="text" name="a" value="<?php echo $row["value"];?>" readonly=""></center></td>
				</tr>
				<?php
				$sql="SELECT value FROM myupdates WHERE cropname='bigonion'";
$result= mysqli_query($conn,$sql);
$row=mysqli_fetch_array($result);
?>
				<tr>
					...
					<td><a href="bigonion.php" ><center><b>Big Onion</b>(1kg)</center></a></td>
						<td><center><input type="text" name="b" value="<?php echo $row["value"];?>" readonly=""></center></td>
				</tr>
				<tr>
