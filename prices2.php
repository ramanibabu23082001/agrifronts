...
$d=$_POST['id'];
  ...
  $numbers=mt_rand(0,999999);
  $sql="SELECT *FROM products WHERE id='$numbers'";
...
echo "re enter the details";
  ...
  $sql= "INSERT INTO products(id,customer,crop,amount,farmer,message)VALUES ('$numbers','$a','$b','$c','$d','order placed')";
